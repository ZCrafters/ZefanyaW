...
document.addEventListener('DOMContentLoaded', function() {
    // Throttling utility for smooth animations
    ...
    if (canvasContainer) {
        canvasContainer.addEventListener('mousemove', rafThrottle((e) => {
    ...
    buttons.forEach(button => {
        button.addEventListener('mousemove', rafThrottle(function(e) {
